...
bind_rows(
  get_portfolio_returns(pobj, today() - days(1) - hours(1)),
  get_portfolio_returns(pobj, today() - weeks(1) - hours(1)),
  get_portfolio_returns(pobj, today() - months(1) - hours(1)),
  get_portfolio_returns(pobj, floor_date(today(), unit = "year")),
  get_portfolio_returns(pobj, today() -years(1) - hours(1))
) %>% 
